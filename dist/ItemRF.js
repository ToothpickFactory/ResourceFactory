...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/ItemRF.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/*!***********************!*\
  !*** ./src/ItemRF.ts ***!
  \***********************/
/*! exports provided: ItemRF */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ItemRF", function() { return ItemRF; });
/* harmony import */ var _ResourceFactory__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ResourceFactory */ "./src/ResourceFactory.ts");
...
let ItemRF = class ItemRF {
};
ItemRF = __decorate([
    Object(_ResourceFactory__WEBPACK_IMPORTED_MODULE_0__["ResourceFactory"])({
        model: Item
    })
], ItemRF);
...
/* harmony import */ var _node_modules_rxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../node_modules/rxjs */ "./node_modules/rxjs/_esm5/index.js");

function ResourceFactory(config) {
    const resources = [];
    const model = config.model;
    const observable = _node_modules_rxjs__WEBPACK_IMPORTED_MODULE_0__["Observable"].create(o => {
        o.next(resources);
    });
    const create = (input) => {
...
/******/ });
//# sourceMappingURL=ItemRF.js.map